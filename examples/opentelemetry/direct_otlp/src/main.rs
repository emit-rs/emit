...
See [the docs](https://docs.rs/emit_otlp/1.19.0/emit_otlp/index.html#configuring-from-environment-variables) for more details on supported environment variables.
*/
