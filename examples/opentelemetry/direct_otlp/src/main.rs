...
See [the docs](https://docs.rs/emit_otlp/2.22.0/emit_otlp/index.html#configuring-from-environment-variables) for more details on supported environment variables.
*/
