...
See [the docs](https://docs.rs/emit_otlp/1.20.1/emit_otlp/index.html#configuring-from-environment-variables) for more details on supported environment variables.
*/
