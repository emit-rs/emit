                ...
                (__tmp0, __tmp1) => {
                    emit::__private::__private_emit(
                        ...
                        &({
                            ...
                            struct __Props<__I0, __F0, __I1, __F1> {
                                __i0: __I0,
                                __f0: __F0,
                                __i1: __I1,
                                __f1: __F1,
                                __marker: emit::__private::core::marker::PhantomData<
                                    (__I0, __F0, __I1, __F1),
                                >,
                            }
                            impl<
                                ...
                                __F0: Fn(
                                        &__I0,
                                            ...
                                            emit::Str<'_>,
                                            emit::__private::core::option::Option<emit::Value<'_>>,
                                        ),
                                __I1,
                                __F1: Fn(
                                        &__I1,
                            ...
                            > emit::Props for __Props<__I0, __F0, __I1, __F1> {
                                fn for_each<
                                    'kv,
                                    F: emit::__private::core::ops::FnMut(
                                            emit::Str<'kv>,
                                            emit::Value<'kv>,
                                        ) -> emit::__private::core::ops::ControlFlow<()>,
                                >(
                                    &'kv self,
                                    mut for_each: F,
                                ) -> emit::__private::core::ops::ControlFlow<()> {
                                    match (self.__f0)(&self.__i0) {
                                        (k, emit::__private::core::option::Option::Some(v)) => {
                                            for_each(k, v)?
                                        }
                                        _ => {}
                                    }
                                    match (self.__f1)(&self.__i1) {
                                        (k, emit::__private::core::option::Option::Some(v)) => {
                                            for_each(k, v)?
                                        }
                                        _ => {}
                    ...
                    emit::__private::__private_emit_event(
                        ...
                        &(emit::__private::__private_evt(
                            ...
                            &(emit::Empty),
                            {
                                ...
                                > emit::value::ToValue for __Props<__I0, __F0> {
                                    fn to_value(&self) -> emit::Value<'_> {
                                        (self.__f0)(&self.__i0).1.to_value()
                                    }
                                }
                                impl<
                                    __I0,
                                ...
                                > emit::Props for __Props<__I0, __F0> {
                                    fn for_each<
                                        'kv,
                                        F: emit::__private::core::ops::FnMut(
                                                emit::Str<'kv>,
    ...
    fn emit_props_precedence() {
        ...
        emit::Frame::push(
                rt.ctxt(),
                {
                    #[allow(unused_imports)]
                    use emit::__private::__PrivateInferInput;
                    struct __Props<__I2, __F2, __I1, __F1, __I0, __F0> {
                        __i2: __I2,
                        __f2: __F2,
                        __i1: __I1,
                        __f1: __F1,
                    ...
                    > emit::Props for __Props<__I2, __F2, __I1, __F1, __I0, __F0> {
                        fn for_each<
                            'kv,
                            F: emit::__private::core::ops::FnMut(
                                    emit::Str<'kv>,
                            ...
                            emit::__private::__private_emit(
                                ...
                                &({
                                    ...
                                    > {
                                        ...
                                        __f2: __F2,
                                        __marker: emit::__private::core::marker::PhantomData<
                                            (__I1, __F1, __I0, __F0, __I3, __F3, __I2, __F2),
                                        >,
                                    }
                                    impl<
                                        __I1,
        ...
        let evt = emit::__private::__private_evt(
            ...
            &(emit::Empty),
            {
                ...
                struct __Props<__I0, __F0> {
                    __i0: __I0,
                    __f0: __F0,
                    __marker: emit::__private::core::marker::PhantomData<(__I0, __F0)>,
                }
                impl<
                    __I0,
                    __F0: Fn(
...
mod metric {
    ...
    fn metric() {
        ...
        match emit::__private::__private_metric(
            ...
            evt => {
                match (&42, &evt.value().to_value().cast::<usize>().unwrap()) {
                    (left_val, right_val) => {
                        if !(*left_val == *right_val) {
                            let kind = ::core::panicking::AssertKind::Eq;
                            ::core::panicking::assert_failed(
...
mod props {
    ...
    fn props_basic() {
        let props = {
            #[allow(unused_imports)]
            use emit::__private::__PrivateInferInput;
            struct __Props<__I1, __F1, __I0, __F0, __I2, __F2, __I3, __F3> {
                __i1: __I1,
                __f1: __F1,
                __i0: __I0,
                __f0: __F0,
                ...
                __f3: __F3,
                __marker: emit::__private::core::marker::PhantomData<
                    (__I1, __F1, __I0, __F0, __I2, __F2, __I3, __F3),
                >,
            }
            impl<
                __I1,
            ...
            > emit::Props for __Props<__I1, __F1, __I0, __F0, __I2, __F2, __I3, __F3> {
                fn for_each<
                    'kv,
                    F: emit::__private::core::ops::FnMut(
                            emit::Str<'kv>,
    ...
    fn props_event_meta() {
        let _ = {
            #[allow(unused_imports)]
            use emit::__private::__PrivateInferInput;
            struct __Props<__I4, __F4, __I3, __F3, __I2, __F2, __I1, __F1, __I0, __F0> {
                __i4: __I4,
                __f4: __F4,
                __i3: __I3,
                __f3: __F3,
                ...
                __f0: __F0,
                __marker: emit::__private::core::marker::PhantomData<
                    (__I4, __F4, __I3, __F3, __I2, __F2, __I1, __F1, __I0, __F0),
                >,
            }
            impl<
                __I4,
            ...
            > emit::Props
            for __Props<__I4, __F4, __I3, __F3, __I2, __F2, __I1, __F1, __I0, __F0> {
                fn for_each<
                    'kv,
                    F: emit::__private::core::ops::FnMut(
                            emit::Str<'kv>,
            ...
            let __i3 = "message";
            let __i2 = "template";
            let __i1 = "2024-01-01T00:00:01.000Z";
            let __i0 = "2024-01-01T00:00:00.000Z";
            __Props {
                __f4: (&__i4)
                    .__private_infer_input(|__i4| (
                        #[allow(unused_imports)]
                        {
                            use emit::__private::{
                                __PrivateKeyHook as _, __PrivateInterpolatedHook as _,
    ...
    fn props_cfg() {
        let props = {
            #[allow(unused_imports)]
            use emit::__private::__PrivateInferInput;
            struct __Props<__I1, __F1, __I0, __F0> {
                __i1: __I1,
                __f1: __F1,
                __i0: __I0,
                __f0: __F0,
            ...
            > emit::Props for __Props<__I1, __F1, __I0, __F0> {
                fn for_each<
                    'kv,
                    F: emit::__private::core::ops::FnMut(
                            emit::Str<'kv>,
    ...
    fn props_capture_trace_id_string() {
        let props = {
            ...
            let __i0 = "00000000000000000000000000000001";
            __Props {
                __f0: (&__i0)
                    .__private_infer_input(|__i0| (
                        #[allow(unused_imports)]
    ...
    fn props_capture_trace_id_u128() {
        let props = {
            ...
            let __i0 = 0x00000000000000000000000000000001u128;
            __Props {
                __f0: (&__i0)
                    .__private_infer_input(|__i0| (
                        #[allow(unused_imports)]
    ...
    fn props_capture_span_id_u64() {
        let props = {
            ...
            let __i0 = 0x0000000000000001u64;
            __Props {
                __f0: (&__i0)
                    .__private_infer_input(|__i0| (
                        #[allow(unused_imports)]
    ...
    fn props_optional() {
        let props = {
            ...
            let __i1 = ::std::option::Option::None::<&i32>;
            let __i0 = ::std::option::Option::Some(&1);
            __Props {
                __f1: (&__i1)
                    .__private_infer_input(|__i1| (
                        #[allow(unused_imports)]
    ...
    fn props_as_value() {
        ...
        let props = {
            #[allow(unused_imports)]
            use emit::__private::__PrivateInferInput;
            struct __Props<__I0, __F0, __I2, __F2, __I1, __F1> {
                __i0: __I0,
                __f0: __F0,
                __i2: __I2,
                __f2: __F2,
            ...
            > emit::Props for __Props<__I0, __F0, __I2, __F2, __I1, __F1> {
                fn for_each<
                    'kv,
                    F: emit::__private::core::ops::FnMut(
                            emit::Str<'kv>,
            ...
            let __i0 = Data;
            let __i2 = ::std::option::Option::None::<Data>;
            let __i1 = ::std::option::Option::Some(Data);
            __Props {
                __f0: (&__i0)
                    .__private_infer_input(|__i0| (
                        #[allow(unused_imports)]
                    ...
                    emit::__private::__private_sample(
                        ...
                        &({
                            ...
                            > {
                                ...
                                __f2: __F2,
                                __marker: emit::__private::core::marker::PhantomData<
                                    (__I3, __F3, __I1, __F1, __I0, __F0, __I2, __F2),
                                >,
                            }
                            impl<
                                __I3,
                            ...
                            > emit::Props
                            for __Props<__I3, __F3, __I1, __F1, __I0, __F0, __I2, __F2> {
                                fn for_each<
                                    'kv,
                                    F: emit::__private::core::ops::FnMut(
                                            emit::Str<'kv>,
                            ...
                            let __i3 = "custom_kind";
                            let __i1 = "sum";
                            let __i0 = "my_other_metric";
                            let __i2 = 13;
                            __Props {
                                __f3: (&__i3)
                                    .__private_infer_input(|__i3| (
...
mod span {
    ...
    extern crate test;
    #[rustc_test_marker = "span::span_name"]
    #[doc(hidden)]
    pub const span_name: test::TestDescAndFn = test::TestDescAndFn {
        desc: test::TestDesc {
            name: test::StaticTestName("span::span_name"),
            ignore: false,
            ignore_message: ::core::option::Option::None,
            source_file: "test/ui/src/span.rs",
            start_line: 339usize,
        ...
        testfn: test::StaticTestFn(
            #[coverage(off)]
            || test::assert_test_result(span_name()),
        ),
    };
    fn span_name() {
        static RT: StaticRuntime = static_runtime(
    ...
    extern crate test;
    #[rustc_test_marker = "span::span_name_custom"]
    #[doc(hidden)]
    pub const span_name_custom: test::TestDescAndFn = test::TestDescAndFn {
        desc: test::TestDesc {
            name: test::StaticTestName("span::span_name_custom"),
            ignore: false,
            ignore_message: ::core::option::Option::None,
            source_file: "test/ui/src/span.rs",
            start_line: 360usize,
        ...
        testfn: test::StaticTestFn(
            #[coverage(off)]
            || test::assert_test_result(span_name_custom()),
        ),
    };
    fn span_name_custom() {
        static RT: StaticRuntime = static_runtime(
            |evt| {
                match (&"custom", &evt.props().pull::<&str, _>("span_name").unwrap()) {
                    (left_val, right_val) => {
                        if !(*left_val == *right_val) {
                            let kind = ::core::panicking::AssertKind::Eq;
                            ::core::panicking::assert_failed(
