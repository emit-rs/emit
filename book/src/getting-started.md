...
Initialize `emit` at the start of your `main.rs` using [`emit::setup()`](https://docs.rs/emit/0.11.3/emit/setup/index.html), and ensure any emitted diagnostics are flushed by calling [`blocking_flush()`](https://docs.rs/emit/0.11.3/emit/setup/struct.Init.html#method.blocking_flush) at the end:
...
When something of note happens, use [`debug!`](https://docs.rs/emit/0.11.3/emit/macro.debug.html) or [`info!`](https://docs.rs/emit/0.11.3/emit/macro.info.html) to log it:
...
When something fails, use [`warn!`](https://docs.rs/emit/0.11.3/emit/macro.warn.html) or [`error!`](https://docs.rs/emit/0.11.3/emit/macro.error.html):
...
Add [`#[span]`](https://docs.rs/emit/0.11.3/emit/attr.span.html) to a significant function in your application to trace its execution:
...
Use the [`dbg!`](https://docs.rs/emit/0.11.3/emit/macro.dbg.html) macro to help debug code as you're writing it:
...
- [the API docs](https://docs.rs/emit/0.11.3/emit/index.html).
