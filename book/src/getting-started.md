...
Initialize `emit` at the start of your `main.rs` using [`emit::setup()`](https://docs.rs/emit/2.22.1/emit/setup/index.html), and ensure any emitted diagnostics are flushed by calling [`blocking_flush()`](https://docs.rs/emit/2.22.1/emit/setup/struct.Init.html#method.blocking_flush) at the end:
...
You can configure `emit` to write to [OpenTelemetry](https://docs.rs/emit_otlp/2.22.1/emit_otlp/index.html), [the console](https://docs.rs/emit_term/2.22.1/emit_term/index.html), [rolling files](https://docs.rs/emit_file/2.22.1/emit_file/index.html), or any custom emitter you create.

Start peppering diagnostics through your application with `emit`'s macros.

## Logging events

When something of note happens, use [`debug!`](https://docs.rs/emit/2.22.1/emit/macro.debug.html) or [`info!`](https://docs.rs/emit/2.22.1/emit/macro.info.html) to log it:
...
When something fails, use [`warn!`](https://docs.rs/emit/2.22.1/emit/macro.warn.html) or [`error!`](https://docs.rs/emit/2.22.1/emit/macro.error.html):
...
Add [`#[span]`](https://docs.rs/emit/2.22.1/emit/attr.span.html) to a significant function in your application to trace its execution:
...
Use [`sample!`](https://docs.rs/emit/2.22.1/emit/macro.sample.html) to write samples of the metrics your application tracks as events:
...
Use the [`dbg!`](https://docs.rs/emit/2.22.1/emit/macro.dbg.html) macro to help debug code as you're writing it:
...
- [the API docs](https://docs.rs/emit/2.22.1/emit/index.html).
