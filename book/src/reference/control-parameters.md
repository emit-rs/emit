...
See [the crate docs](https://docs.rs/emit/1.20.0/emit/macro.emit.html#control-parameters) for control parameters on `emit!`.

## `#[span]`

See [the crate docs](https://docs.rs/emit/1.20.0/emit/attr.span.html#control-parameters) for control parameters on `#[span]`.
