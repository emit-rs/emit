...
You can use [`emit_term`](https://docs.rs/emit_term/1.9.0/emit_term/index.html) to write diagnostic events to the console in a human-readable format:
...
See [the crate docs](https://docs.rs/emit_term/1.9.0/emit_term/index.html) for more details.
