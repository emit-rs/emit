...
Emitters write their own diagnostics to an alternative `emit` runtime, which you can configure via [`init_internal`](https://docs.rs/emit/0.11.6/emit/setup/struct.Setup.html#method.init_internal) to debug them:
