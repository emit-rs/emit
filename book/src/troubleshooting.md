...
Emitters write their own diagnostics to an alternative `emit` runtime, which you can configure via [`init_internal`](https://docs.rs/emit/1.20.0/emit/setup/struct.Setup.html#method.init_internal) to debug them:
