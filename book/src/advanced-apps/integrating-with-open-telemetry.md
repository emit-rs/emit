...
You can configure `emit` to send its diagnostics to the OpenTelemetry SDK using [`emit_opentelemetry`](https://docs.rs/emit_opentelemetry/0.11.0/emit_opentelemetry/index.html). See [the crate docs](https://docs.rs/emit_opentelemetry/0.11.0/emit_opentelemetry/index.html) for more details.
