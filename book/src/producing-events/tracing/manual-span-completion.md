...
Completions can be created using the [`completion::from_fn`](https://docs.rs/emit/1.20.0/emit/span/completion/fn.from_fn.html) function, or by implementing the [`Completion`](https://docs.rs/emit/1.20.0/emit/span/completion/trait.Completion.html) trait.
