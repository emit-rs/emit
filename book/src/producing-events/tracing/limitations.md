...
- No distinction between sampling and reporting; if a span exists, it's sampled. You can use [`emit_traceparent`](https://docs.rs/emit_traceparent/2.22.4/emit_traceparent/) to add sampling support.
- No span events.
