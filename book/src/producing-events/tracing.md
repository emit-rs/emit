...
- [`#[debug_span]`](https://docs.rs/emit/1.8.0/emit/attr.debug_span.html)
- [`#[info_span]`](https://docs.rs/emit/1.8.0/emit/attr.info_span.html)
- [`#[warn_span]`](https://docs.rs/emit/1.8.0/emit/attr.warn_span.html)
- [`#[error_span]`](https://docs.rs/emit/1.8.0/emit/attr.error_span.html)
