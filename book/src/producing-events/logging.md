...
- [`debug!`](https://docs.rs/emit/1.8.0/emit/macro.debug.html) for events supporting live debugging.
- [`info!`](https://docs.rs/emit/1.8.0/emit/macro.info.html) for most informative events.
- [`warn!`](https://docs.rs/emit/1.8.0/emit/macro.warn.html) for errors that didn't cause the calling operation to fail.
- [`error!`](https://docs.rs/emit/1.8.0/emit/macro.error.html) for errors that caused the calling operation to fail.
