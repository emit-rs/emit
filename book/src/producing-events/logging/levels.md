...
- [`debug!`](https://docs.rs/emit/1.4.1/emit/macro.debug.html)
- [`info!`](https://docs.rs/emit/1.4.1/emit/macro.info.html)
- [`warn!`](https://docs.rs/emit/1.4.1/emit/macro.warn.html)
- [`error!`](https://docs.rs/emit/1.4.1/emit/macro.error.html)
