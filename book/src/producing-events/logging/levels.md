...
- [`debug!`](https://docs.rs/emit/0.11.0-alpha.21/emit/macro.debug.html)
- [`info!`](https://docs.rs/emit/0.11.0-alpha.21/emit/macro.info.html)
- [`warn!`](https://docs.rs/emit/0.11.0-alpha.21/emit/macro.warn.html)
- [`error!`](https://docs.rs/emit/0.11.0-alpha.21/emit/macro.error.html)
