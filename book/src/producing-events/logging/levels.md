...
- [`debug!`](https://docs.rs/emit/2.22.0/emit/macro.debug.html)
- [`info!`](https://docs.rs/emit/2.22.0/emit/macro.info.html)
- [`warn!`](https://docs.rs/emit/2.22.0/emit/macro.warn.html)
- [`error!`](https://docs.rs/emit/2.22.0/emit/macro.error.html)
...
To use a custom level, you can specify your own value for the `lvl` [well-known property](https://docs.rs/emit/2.22.0/emit/well_known/index.html) when emitting an event:
