...
- [`debug!`](https://docs.rs/emit/1.2.0/emit/macro.debug.html)
- [`info!`](https://docs.rs/emit/1.2.0/emit/macro.info.html)
- [`warn!`](https://docs.rs/emit/1.2.0/emit/macro.warn.html)
- [`error!`](https://docs.rs/emit/1.2.0/emit/macro.error.html)
