...
- [`Level`](https://docs.rs/emit/1.19.0/emit/level/enum.Level.html): A simplified severity enum associated with log events. See [Log levels](./levels.md) for more details.
