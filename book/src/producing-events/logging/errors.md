...
You can also use the [`#[as_error]`](https://docs.rs/emit/0.11.0-alpha.18/emit/attr.as_error.html) attribute on a property to capture it using its `Error` implementation.

The [`#[span]`](https://docs.rs/emit/0.11.0-alpha.18/emit/attr.span.html) macro can automatically capture errors from fallible functions. See [Fallible functions](../tracing/fallible-functions.md) for details.
