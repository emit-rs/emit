...
`emit` can be configured in `#[test]` functions using the [`#[span]`](https://docs.rs/emit/1.20.0/emit/attr.span.html) attribute. There are several useful [control parameters](../reference/control-parameters.md) you can use to improve diagnostics in tests:
