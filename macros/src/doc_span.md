...
| `evt_props`    | `impl emit::Props`            | A set of properties to attach to the span guard (see the `guard` parameter) that will appear on the emitted span event, but not pushed to the ambient context.                      |
